        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissionTitleAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MissionTitleEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MissionIconName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MissionDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MissionDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisionTitleAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisionTitleEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisionIconName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisionDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisionDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValueTitleAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValueTitleEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValueIconName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValueDescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValueDescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AboutUs_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AboutUs_AspNetUsers_DeletedUserId",
                        column: x => x.DeletedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AboutUs_AspNetUsers_LastModifiedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Partner_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Partner_AspNetUsers_DeletedUserId",
                        column: x => x.DeletedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Partner_AspNetUsers_LastModifiedUserId",
                        column: x => x.LastModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SiteInfo_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SiteInfo_AspNetUsers_DeletedUserId",
                        column: x => x.DeletedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SiteInfo_AspNetUsers_LastModifiedUserId",
                        column: x => x.LastModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Answer_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Answer_AspNetUsers_DeletedUserId",
                        column: x => x.DeletedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Answer_AspNetUsers_LastModifiedUserId",
                        column: x => x.LastModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctor_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Doctor_AspNetUsers_DeletedUserId",
                        column: x => x.DeletedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Doctor_AspNetUsers_LastModifiedUserId",
                        column: x => x.LastModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "63998b7d-6724-49a6-8488-0798f13726d5", "a75c163e-6a53-4376-b426-04192fcefcaa", "Developer", "مبرمج", "DEVELOPER", 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "5e46158f-44e1-4e78-8101-8a4617d5daba", 0, "b795837e-ee8a-41ac-aed4-3fea2f771308", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3521), null, false, "ERP Developer", "profile-icon.jpg", false, true, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3522), true, null, null, "DEVELOPER", "123456", "AQAAAAEAACcQAAAAEHaohoeqzEiX/FGJWJ4i64MQ6gJjBAQ1ywiJKpFTlBacjNpMMDJCYRjyZcDfdeS57Q==", null, false, "THFLQTJYXMDTPEPOVONPR6R2WZBOCJMA", "Developer", false, "Developer" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "123456", "المملكة العربية السعودية", "الشركة", "Company", "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3663), null, "test@example.com", "123456", new DateTime(2022, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3659), null, "Riadh", "//test.jpg", "No", "01204789654", "01204789654", "01204789654", "1234", "1234", "www.Ansari.Com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "سعودي", "Saudian", "1", "السعودية", "KSA", "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3724), null, "NO", true, false, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3724), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "", "", "1", "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3712), "العملة الافتراضية", "Default Currency", null, 1m, null, true, false, true, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3713), null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3738), null, "", true, false, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3738), null, "1", "مسلم", "Mulslim" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "عنوان الفرع", "1", "الفرع الرئيسي", "Main Branch", "123456", "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3676), null, 1, null, null, "test@example.com", "123456", "123456", "123456", true, false, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3677), null, "//test.jpg", "No", "01204789654", "01204789654", "01204789654", "1234", "1234", "www.Ansari.Com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "5e46158f-44e1-4e78-8101-8a4617d5daba", "5e46158f-44e1-4e78-8101-8a4617d5daba", new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3692), 1, null, true, false, false, new DateTime(2022, 12, 7, 17, 7, 48, 305, DateTimeKind.Local).AddTicks(3693), null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AboutUs_CreatedUserId",
                table: "AboutUs",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AboutUs_DeletedUserId",
                table: "AboutUs",
                column: "DeletedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AboutUs_LastModifiedUserId",
                table: "AboutUs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answer_CreatedUserId",
                table: "Answer",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Answer_DeletedUserId",
                table: "Answer",
                column: "DeletedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Answer_LastModifiedUserId",
                table: "Answer",
                column: "LastModifiedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctor_CreatedUserId",
                table: "Doctor",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Doctor_DeletedUserId",
                table: "Doctor",
                column: "DeletedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctor_LastModifiedUserId",
                table: "Doctor",
                column: "LastModifiedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Partner_CreatedUserId",
                table: "Partner",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Partner_DeletedUserId",
                table: "Partner",
                column: "DeletedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Partner_LastModifiedUserId",
                table: "Partner",
                column: "LastModifiedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteInfo_CreatedUserId",
                table: "SiteInfo",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteInfo_DeletedUserId",
                table: "SiteInfo",
                column: "DeletedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteInfo_LastModifiedUserId",
                table: "SiteInfo",
                column: "LastModifiedUserId");
