...
public class FileHandler : IFileHandler
{
    ...
    public string UploadFile(string uploadFolder, IFormFile file, string? mainFolderPath = null)
    {
        var fileName = string.Empty;
        try
        {
            if(mainFolderPath == null)
                mainFolderPath = Path.Combine(_hostingEnvironment.WebRootPath, "images");
